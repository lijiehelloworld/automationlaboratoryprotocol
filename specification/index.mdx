...
<CardGroup cols={2}>
  ...
  <Card title="设备接口要求" href="/specification/device-integration/overview">说明对象、操作和系统三类设备接口。</Card>
  <Card title="技能提取" href="/specification/capability/overview">生成、质检并准入设备技能。</Card>
