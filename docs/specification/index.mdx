...
<CardGroup cols={2}>
  ...
  <Card title="语言引擎概述" href="/docs/specification/engine/overview">从 FSP 获取能力，通过 Agent 生成流程，循环仿真并交付执行。</Card>
  <Card title="编译/解释器" href="/docs/specification/engine/compiler">注册能力、生成程序并根据证据推进程序路径。</Card>
  <Card title="仿真器" href="/docs/specification/engine/simulator">验证参数、状态和系统安全限制。</Card>
  <Card title="执行器" href="/docs/specification/engine/executor">解析任务，查询当前可用设备，再向 FSP 下发并核验结果。</Card>
  <Card title="FSP 概述" href="/docs/specification/fsp/overview">理解 FSP 服务实现与设备仪器接口要求的关系。</Card>
  ...
  <Card title="转发器" href="/docs/specification/fsp/adapter">了解单位转换、驱动调用和结果解释的处理逻辑。</Card>
